<template>
  <div id="page">
    <nav class="image-container">
        <img src="@/assets/danang/dng01.jpg" width="995">
        <img src="@/assets/danang/hill.jpg" width="995">
        ...
        <img src="@/assets/danang/dng07.webp" width="995">
        <img src="@/assets/danang/dng02.jpg" width="995">
        ...
        <img src="@/assets/danang/dng03.jpg" width="995">
        <img src="@/assets/danang/five.jpg" width="995">
        ...
        <img src="@/assets/danang/hue01.jpg" width="995">
        <img src="@/assets/danang/hue02.jpg" width="995">
        ...
        <section class="shining03">
            ...
            <table class="img">
                <tr>
                    <td class="scale"><a href="https://www.myrealtrip.com/contents/25?contents_id=25"><img src="@/assets/danang/rv01.jpg" width="320"></a></td>
                    <td class="scale"><a href="https://www.myrealtrip.com/contents/21?contents_id=21"><img src="@/assets/danang/rv02.jpg" width="320"></a></td>
                    <td class="scale"><a href="https://www.myrealtrip.com/contents/15?contents_id=15"><img src="@/assets/danang/rv03.jpg" width="320"></a></td>
                </tr>
            </table>
        </section>
    </nav>
    ...
    <div id="pack">
      <section>
        <hr size="7" noshade>
        <h2 style="text-align:left; margin:20px;">패키지</h2>
        <table>
          <tr>
            <td><a href=""><img src="@/assets/danang/pk01.jpg" width="210"></a></td>
            <td><a href=""><img src="@/assets/danang/pk02.jpg" width="210"></a></td>
            <td><a href=""><img src="@/assets/danang/pk03.jpg" width="210"></a></td>
            <td><a href=""><img src="@/assets/danang/pk04.webp" width="210"></a></td>
          </tr>
          <tr>
            <td><strong>다낭/호이안 4~6일 #가성비부터 #가심비까지 #5성호텔 </strong></td>
            <td><strong>다낭/호이안 4~6일 #베스트셀러 #5성급호텔 #호이안 핵심일정</strong></td>
            <td><strong>다낭 5일 #가성비 #시내4성호텔 #바나산 #호이안투어 #자유시간 #쇼핑3회</strong></td>
            <td><strong>[초특가-실버트립] 다낭/호이안/후에 4박6일 [무엉탄럭셔리or래디슨]</strong></td>
          </tr>
          <tr>
